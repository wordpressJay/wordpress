...
if ( ! function_exists( 'fleming_get_pages' ) ) :
/**
 ...
 */
function fleming_get_pages() {

    $choices = array( 0 );

    // Default
    $choices = array( 'none' => esc_html__( 'None', 'fleming' ) );
    ...
    return apply_filters( 'fleming_get_pages', $choices );
}
endif;

if ( ! function_exists( 'fleming_sanitize_pages' ) ) :
/**
 ...
 */
function fleming_sanitize_pages( $value ) {
